...
import com.registeration.ang.apiModels.ApiUserLoginRequest;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			// get email / password in the UserLoginRequestModel from the HttpServletRequest
			ApiUserLoginRequest cred = new ObjectMapper().readValue(request.getInputStream(),
					ApiUserLoginRequest.class);
	...
	protected void successfulAuthentication(HttpServletRequest req,
		...
		// get userService bean from the context to access the DB to get a user 
